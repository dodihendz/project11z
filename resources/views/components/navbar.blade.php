                ...
                <div class="flex items-center">
                    ...
                    <div class="hidden md:block">
                        <div class="ml-10 flex items-baseline space-x-4">
                            ...
                            {{-- <a href="/"
                                class="{{ request()->is('/') ? 'text-white bg-gray-900' : 'text-gray-300 hover:bg-white/5 hover:text-white' }} rounded-md px-3 py-2 text-sm font-medium ">Home</a>
                            <a href="/blog"
                                class="{{ request()->is('/blog') ? 'text-white bg-gray-900' : 'text-gray-300 hover:bg-white/5 hover:text-white' }} rounded-md px-3 py-2 text-sm font-medium ">Blog</a>
                            <a href="/contact"
                                class="{{ request()->is('/contact') ? 'text-white bg-gray-900' : 'text-gray-300 hover:bg-white/5 hover:text-white' }} rounded-md px-3 py-2 text-sm font-medium ">Contact</a>
                            <a href="/about"
                                class="{{ request()->is('/about') ? 'text-white bg-gray-900' : 'text-gray-300 hover:bg-white/5 hover:text-white' }} rounded-md px-3 py-2 text-sm font-medium ">About</a> --}}
                        </div>
                    </div>
                </div>
                <div class="hidden md:block">
